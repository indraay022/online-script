...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=7076 -o /tmp/$package $CURLOPTIONS --insecure
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:CC4FA8EF-2934-4319-48E4-27FE30E1A94F" "token:C4C471F6-620D-043D-5883-D49537E3D442" "policyid:68" "groupid:334"
# /opt/ds_agent/dsa_control -a dsm://agents.workload.sg-1.cloudone.trendmicro.com:443/ "tenantID:CC4FA8EF-2934-4319-48E4-27FE30E1A94F" "token:C4C471F6-620D-043D-5883-D49537E3D442" "policyid:68" "groupid:334"